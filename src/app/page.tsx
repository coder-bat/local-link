...
export default function Home() {
  ...
  return (
    <main className="min-h-screen w-full flex flex-col items-center justify-center bg-gradient-to-br from-sky-200 via-blue-300 to-cyan-400 relative overflow-hidden">
      ...
      <section className="mt-12 w-full max-w-2xl bg-white/80 rounded-2xl shadow-lg p-6 flex flex-col items-center gap-6 border border-blue-100">
        <h3 className="text-2xl font-semibold text-slate-900">How it works?</h3>
        <p className="text-sm text-center">
          Click on any button above, and your neighbour who sent you QR code will receive a SMS notification on their phone.
        </p>
        <p className="text-sm text-center">No phone numbers are shared. All communication is anonymous and secure. Address is identified by unique QR code.</p>
      </section>
